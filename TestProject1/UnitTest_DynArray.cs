...
namespace TestProject
{
    ...
    public class AlgorithmsDataStructures
    {
        ...
        [TestMethod]
        //[ExpectedException(typeof(ArgumentOutOfRangeException))]
        [TestCategory("Исключение при вставке в пустой массив/Некорректная вставка в пустой массив")]
        public void DynArray_Insert_zero_pozition_in_empty_array()
        {
            try
            {
                DynArray<int> dynArray = new()
        ...
        [TestMethod]
        //[ExpectedException(typeof(ArgumentOutOfRangeException))]
        [TestCategory("Некорректная вставка после единственного элемента")]
        public void DynArray_Insert_after_single_element()
        {
            try
            {
                DynArray<int> dynArray = new()
        ...
        public void DynArray_Remove_from_empty_array_remove_zero()
        {
            try
            {
                DynArray<int> dynArray = new()
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        [TestCategory("Некорректная работа удаления из пустого массива")]
        public void DynArray_Remove_from_empty_arra_remove_not_exist_element()
        {
            try
            {
                DynArray<int> dynArray = new()
